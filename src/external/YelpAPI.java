...
public class YelpAPI {
    ...
    //according to latitude and longitude, return a JSON array 
    public  List<Item> search(double lat, double lon, String term) {
        ...
        try {
        	...
        	int responseCode = connection.getResponseCode();  //Get the status code from an HTTP response message. It¡¯ll send the request first and then get response code. If code is 200, OK,
